...
if (this.version != 5) {
  ...
  writer.writeUInt8(this.zelnodeData.nType);
   if (this.zelnodeData.nType == ZELNODE_START_TX_TYPE) {
    ...
    writer.writeUInt64LE(this.zelnodeData.sigTime);
    writer.writeVarintNum(this.zelnodeData.IP.length)
    writer.write(this.zelnodeData.IP);
  ...
  if (this.zelnodeData.nType == ZELNODE_CONFIRM_TX_TYPE) {
    ...
    writer.writeUInt64LE(this.zelnodeData.benchmarkSigTime);
...
Transaction.prototype.fromBufferReader = function(reader) {
  ...
  if (this.zelnodeData.nType == ZELNODE_START_TX_TYPE) {
    ...
    this.zelnodeData.sigTime = reader.readUInt64LE();
    var sizeIP = reader.readVarintNum();
    this.zelnodeData.IP = reader.read(sizeIP);
  ...
  if (this.zelnodeData.nType == ZELNODE_CONFIRM_TX_TYPE) {
    ...
    this.zelnodeData.benchmarkSigTime = reader.readUInt64LE();
